...
type NodePrinter = {
	(node: Node, depth: number, fieldName: string, uri?: vscode.Uri): string;
};

export function printParseTree(node: Node, options: PrintingOptions, print: NodePrinter = ParseTreeEditor.renderNode): string[] {
